...
class ChatListComponent extends React.Component {
   ...
   render() {
       ...
       if(this.props.chats.length > 0) {
           return(
               <main className={classes.root}>
                   <Button variant='contained'
                       ...
                       {/* List over the active chats, showing email, message and avatar */}
                       <List>
                           {
           ...
           return(
            ...
            // If no messages, just show button with and empty list
               <main className={classes.root}>
                   <Button variant='contained'
                       fullWidth
                       color='primary'
   ...
   // Pulling the selected chat from the database
   selectChat = (index) => {
       this.props.selectChatFn(index);
   }
   // Making sure the wether the sender is the user or the friend
