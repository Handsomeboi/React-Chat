...
class NewChatComponent extends React.Component {
    ...
    // updates the state for username, email and password
    userTyping = (type, e) => {
        switch (type) {
            case 'username':
    ...
    // this will see if there is a user with the written email, then create the chat
    // if there is no user with the written email, nothing will happen
    ...
    // if previous function submitNewChat doesnt find a chat
    // createChat will create a new chat in the database
    createChat = () => {
    ...
    // this function uses userSnapshot to get the user if it exists in the database
    userExists = async () => {
